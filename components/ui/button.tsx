...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        mybutton:"bg-mycolor100 text-neutral-50 shadow hover:bg-mycolor-100/90 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-mycolor-100/90",
        default:
          "bg-neutral-900 text-neutral-50 shadow hover:bg-neutral-900/90 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50/90",
        success: "bg-green-500 text-neutral-50 shadow hover:bg-green-700/90 dark:bg-green-50 dark:text-neutral-900 dark:hover:bg-green-50/90",
